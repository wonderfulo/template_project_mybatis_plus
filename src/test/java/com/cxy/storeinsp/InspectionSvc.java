...
////				mapRows.put(row.id, row);
////			}
//			List<InspectionExportDto> nativeQuery = new ArrayList<>();
//			if (result.size() >= 100){
//				List<List<InspectionEntity>> list = createList(result, 100);
//				for (int i = 0; i < list.size(); i++) {
...
//							+ "LEFT JOIN ( "+ sql2 +" ) tmp ON tmp.inspection_id = d.inspection_id "
//							+ "where d.app_id = '"+user.getAppId() +"'and d.inspection_id in (" + ids + ") ORDER BY d.create_time desc ,d.group_name";
//					List<InspectionExportDto> temp = JPAHelper.nativeQuery(sql1, null, InspectionExportDto.class);
//					nativeQuery.addAll(temp);
//				}
//
//			}else {
//
...
//						+ "LEFT JOIN ( "+ sql2 +" ) tmp ON tmp.inspection_id = d.inspection_id "
//						+ "where d.app_id = '"+user.getAppId() +"'and d.inspection_id in (" + ids + ") ORDER BY d.create_time desc ,d.group_name";
//				 nativeQuery = JPAHelper.nativeQuery(sql1, null, InspectionExportDto.class);
//			}
//
//			for (InspectionExportDto dto : nativeQuery) {
//				//视频素材处理
...
//					.registerWriteHandler(new com.xxy.om.storeinsp.services.CustomCellWriteHandler())
