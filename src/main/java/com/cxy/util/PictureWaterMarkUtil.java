...
//    	String text=Base64.encodeBase64String(logoText.getBytes());
//    	String color=Base64.encodeBase64String(fontColor.getBytes());
...
//    	String color2=Base64.encodeBase64String(fontColor2.getBytes());//http://supershoper.xxynet.com/vsvz1554990541635
...
//        System.out.println(new PictureWaterMarkUtil().addWaterMarkOperator("陈伦"));
//        System.out.println(new PictureWaterMarkUtil().addWaterMark("demo @csb"));
//    }
//}
